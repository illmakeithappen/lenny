...
const _lineStations = <String, List<String>>{
  ...
  'S25': [
    ...
    'Nordbahnhof', 'Oranienburger Straße', 'Friedrichstraße',
    'Brandenburger Tor', 'Potsdamer Platz', 'Anhalter Bahnhof',
    'Yorckstraße', 'Südkreuz', 'Priesterweg', 'Südende', 'Lankwitz',
    'Lichterfelde Ost', 'Osdorfer Straße', 'Lichterfelde Süd',
    'Teltow Stadt',
  ],
  'S26': [
  ...
  'S5': [
    ...
    'Hegermühle', 'Strausberg Stadt', 'Strausberg Nord',
  ],
  'S7': [
    'Potsdam Hauptbahnhof', 'Babelsberg', 'Griebnitzsee', 'Wannsee',
    'Nikolassee', 'Grunewald', 'Westkreuz', 'Charlottenburg', 'Savignyplatz',
    'Zoologischer Garten', 'Tiergarten', 'Bellevue',
    'Hauptbahnhof', 'Friedrichstraße', 'Hackescher Markt',
    'Alexanderplatz', 'Jannowitzbrücke', 'Ostbahnhof',
    'Warschauer Straße', 'Ostkreuz', 'Nöldnerplatz', 'Lichtenberg',
  ...
  'S9': [
    ...
    'Schönefeld', 'Waßmannsdorf', 'Flughafen BER',
  ],

  // Ringbahn
  'S41/S42': [
    'Gesundbrunnen', 'Schönhauser Allee', 'Prenzlauer Allee',
    ...
    'Halensee', 'Westkreuz', 'Messe Nord/ZOB', 'Westend',
  ...
  'S85': [
    'Frohnau', 'Hermsdorf', 'Waidmannslust', 'Wittenau',
    'Wilhelmsruh', 'Schönholz', 'Wollankstraße',
    'Bornholmer Straße', 'Schönhauser Allee', 'Prenzlauer Allee',
    'Greifswalder Straße', 'Landsberger Allee',
    'Storkower Straße', 'Frankfurter Allee', 'Ostkreuz',
    'Treptower Park', 'Plänterwald', 'Baumschulenweg',
    'Schöneweide', 'Johannisthal', 'Adlershof',
