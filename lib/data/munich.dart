...
const munichLines = <LineInfo>[
  ...
  LineInfo(id: 'S5', type: LineType.sBahn, color: Color(0xFF925B0C)),
  ...
  LineInfo(id: 'S20', type: LineType.sBahn, color: Color(0xFFED5793)),
];
...
const _munichLineStations = <String, List<String>>{
  ...
  'U3': [
    ...
    'Olympia-Einkaufszentrum', 'Oberwiesenfeld',
  ...
  'U5': [
    ...
    'Quiddestraße', 'Neuperlach Zentrum',
    'Therese-Giehse-Allee', 'Neuperlach Süd',
  ],
  'U6': [
  ...
  'S1': [
    ...
    'Flughafen Besucherpark', 'Flughafen München',
  ...
  'S2': [
    ...
    'Hebertshausen',
    'Altomünster', 'Kleinberghofen', 'Erdweg', 'Arnbach',
    'Markt Indersdorf', 'Niederroth', 'Schwabhausen', 'Bachern',
    'Dachau Stadt', 'Dachau',
    'Karlsfeld', 'Allach', 'Untermenzing', 'Obermenzing',
    'Laim', 'Hirschgarten', 'Donnersbergerbrücke',
    'Hackerbrücke', 'Hauptbahnhof', 'Karlsplatz (Stachus)',
    'Marienplatz', 'Isartor', 'Rosenheimer Platz', 'Ostbahnhof',
    ...
    'Ottenhofen', 'St. Koloman', 'Aufhausen', 'Altenerding',
    'Erding',
  ],
  'S3': [
  ...
  'S5': [
    'Weßling', 'Neugilching', 'Gilching-Argelsried', 'Geisenbrunn',
  ...
  'S7': [
    ...
    'Höllriegelskreuth', 'Pullach', 'Großhesselohe Isartalbahnhof',
  ...
  'S20': [
    ...
    'Buchenau', 'Fürstenfeldbruck', 'Eichenau', 'Puchheim',
    'Aubing', 'Leienfelsstraße', 'Pasing',
    'Heimeranplatz', 'Mittersendling', 'Siemenswerke',
    'Solln', 'Großhesselohe Isartalbahnhof', 'Pullach',
    'Höllriegelskreuth',
  ],
};
